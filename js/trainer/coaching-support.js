...
function renderClientCoachingModule() {
  ...
  return '<div class="advanced-grid">'
    + '<section class="advanced-card wide"><h3>Client coaching review</h3><p>One decision screen for the evidence already collected elsewhere: onboarding, assigned workouts, set logs, weekly check-ins, pain reports, and optional monitoring.</p>'
