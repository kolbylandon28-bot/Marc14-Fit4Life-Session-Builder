...
function renderTrainerAnalysis(client) {
  ...
  // Above the tabs, not inside one: a client training right now is the most time-sensitive
  // thing on this page, and it was behind "Client details", which nobody opens mid-session.
  const liveNow = liveWorkoutCardHtml(profile);
