...
const LIBRARY = [
  ...
  { name: "Bike easy spin", family: "warmup_cardio", rank: 1, zone: "cardio", pattern: "mobility", region: "cardio", exp: 1, impact: 0, unilateral: false, avoid: [], muscles: [], preps: ["general", "lower"], aliases: ["bike", "cycling", "stationary bike"], cue: "Light resistance, spin to loosen hips and knees." },
  ...
  { name: "Seated hamstring curl", family: "hamstring_curl", rank: 1, zone: "machine", pattern: "hinge", region: "lower", exp: 1, impact: 0, unilateral: false, avoid: [], muscles: ["hamstrings"], aliases: ["leg curl", "hamstring curl"], cue: "Control both directions, avoid yanking — isolates the hamstrings." },
  ...
  /* ---------------- ISOLATION / ACCESSORY ---------------- */
  { name: "Dumbbell curl", family: "biceps", rank: 3, zone: "dumbbell", pattern: "h_pull", region: "pull", exp: 1, impact: 0, unilateral: false, avoid: ["elbow"], muscles: ["arms"], aliases: ["bicep curl", "biceps curl", "arm curl", "curls"], cue: "Elbows pinned, no swing, squeeze at the top." },
  { name: "Cable curl", family: "biceps", rank: 1, zone: "cable", pattern: "h_pull", region: "pull", exp: 1, impact: 0, unilateral: false, avoid: ["elbow"], muscles: ["arms"], aliases: ["bicep curl", "biceps curl"], cue: "Constant tension, control the lowering." },
  ...
  { name: "Assault bike", family: "conditioning", rank: 9, zone: "cardio", pattern: "conditioning", region: "cardio", exp: 1, impact: 0, unilateral: false, avoid: [], muscles: [], aliases: ["bike", "biking", "cycling", "spin bike"], cue: "Arms and legs together. Scales from an easy spin to all-out.", demands: ["sustained_cardio","seated"], safetyReviewed: true, safetyMetadataVersion: 2, safetySource: "inferred", bankId: "assault-bike", bankSource: "built-in" },
...
/* ---------------- ADDED: SQUAT depth ---------------- */
  ...
  { name: "Machine hamstring curl", family: "hamstring_curl", rank: 2, zone: "machine", pattern: "hinge", region: "lower", exp: 1, impact: 0, unilateral: false, avoid: [], muscles: ["hamstrings"], aliases: ["leg curl", "hamstring curl"], cue: "Curl smoothly, lower slower than you lift." },
  ...
  { name: "Incline dumbbell curl", family: "biceps", rank: 5, zone: "dumbbell", pattern: "h_pull", region: "pull", exp: 2, impact: 0, unilateral: false, avoid: ["elbow"], muscles: ["arms"], aliases: ["bicep curl", "biceps curl"], cue: "Arms behind the torso for a bigger biceps stretch." },
  { name: "Hammer curl", family: "biceps", rank: 4, zone: "dumbbell", pattern: "h_pull", region: "pull", exp: 1, impact: 0, unilateral: false, avoid: ["elbow"], muscles: ["arms"], aliases: ["bicep curl", "biceps curl"], cue: "Neutral grip, elbows pinned — brachialis and forearms." },
  { name: "Preacher curl", family: "biceps", rank: 2, zone: "machine", pattern: "h_pull", region: "pull", exp: 2, impact: 0, unilateral: false, avoid: ["elbow"], muscles: ["arms"], aliases: ["bicep curl", "biceps curl"], cue: "No swing possible — control the eccentric fully." },
  ...
  { name: "Sprint", family: "conditioning", rank: 14, zone: "cardio", pattern: "conditioning", region: "cardio", exp: 2, impact: 3, unilateral: false, avoid: ["knee","hip","ankle"], muscles: ["hamstrings","glutes","quads"], aliases: ["sprinting", "sprints", "running fast"], cue: "Full effort, then full recovery. End the set when speed drops off.", demands: ["impact","ballistic","sustained_cardio","standing"], safetyReviewed: true, safetyMetadataVersion: 2, safetySource: "inferred", bankId: "sprint", bankSource: "built-in" },
